<?php
// Filter-panel partial for my-applications.php — included once per tab.
// Expects: $orgOptions, $sectionOptions, $leaveTypeOptions, $scope from parent.
if (!isset($scope)) $scope = 'supervised';
?>
        ...
        <div class="row g-2">
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-6">
                ...
                <div class="field-shell">
                    ...
                    <input type="text" id="<?= $scope ?>DateRange" class="form-control form-control-sm filter-input filter-daterange" data-scope="<?= $scope ?>" placeholder="তারিখ নির্বাচন করুন...">
                </div>
            </div>
        </div>
    </div>
