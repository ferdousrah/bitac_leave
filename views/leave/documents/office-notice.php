 ...
 *
 * Usage: office-notice.php?leaveApplicationID=5516
 */
...
if ($leaveApplicationID <= 0) {
    ...
    <body>
        <div class="error-box">
            ...
            <div class="info">
                <strong>Usage:</strong>
                <div class="example">office-notice.php?leaveApplicationID=<strong>5516</strong></div>
            </div>
        </div>
    </body>
    </html>
...
function generatePDFData($leaveApplicationID) {
    try {
        ...
        // + label set) or a real employee; order comes from `serial` so
        // defaults and employees can be interleaved by the admin.
        if (!empty($copyToList)) {
            $html .= '<p>&nbsp;</p>';
            $html .= '<p>অনুলিপি :</p>';
...
<body>
    <div class="toolbar">
        ...
        <button class="btn btn-info" onclick="printPDF()" id="btnPrint">Print</button>
