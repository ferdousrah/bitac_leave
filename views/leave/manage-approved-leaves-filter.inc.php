<?php
// Filter-panel partial for manage-approved-leaves.php — included once per tab.
// Expects: $secOptions, $joiningTypeMap, $scope from parent.
if (!isset($scope)) $scope = 'pendJ';
?>
