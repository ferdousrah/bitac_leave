...
$menuslug = htmlspecialchars($_GET['menuslug'] ?? 'increment-report');
?>

<!-- Page Header -->
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        <h4 class="fw-bold mb-0"><i class="ti tabler-report-money me-2 text-primary"></i>ইনক্রিমেন্ট রিপোর্ট</h4>
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i>কর্মচারীর বেতন বৃদ্ধির রিপোর্ট জেনারেট করুন</div>
    </div>
...
<div class="card simple-form-card shadow-sm border-0">
    <div class="card-body">
        <form id="incrementReportForm" method="post">
            <!-- Section header -->
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <small class="text-muted mt-1 d-block"><i class="ti tabler-info-circle me-1"></i>যে কর্মচারীর জন্য রিপোর্ট জেনারেট করতে চান তাকে নির্বাচন করুন</small>
                </div>
            </div>
...
═══════════════════════════════════════════════════════ -->
<style>
#incrementReportModal .modal-dialog { max-width: 95vw; margin: 1rem auto; }
#incrementReportModal .modal-content { height: calc(100vh - 2rem); display: flex; flex-direction: column; }
#incrementReportModal .modal-body { flex: 1 1 auto; min-height: 0; padding: 0; position: relative; background: #f5f7fa; }
#incrementReportModal #reportIframe { width: 100%; height: 100%; border: 0; background: #fff; display: block; }
#incrementReportModal #reportLoader {
...
#incrementReportModal #reportLoader.d-none { display: none !important; }
</style>
<div class="modal fade" id="incrementReportModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header py-2 px-3" style="background:linear-gradient(155deg,#0e1e34 0%,#1e3a5f 100%);color:#fff;border:none;">
                <h5 class="modal-title mb-0" style="color:#fff;font-size:1rem;">
                    <i class="ti tabler-report-money me-2"></i>ইনক্রিমেন্ট রিপোর্ট
                </h5>
...
$(document).ready(function() {
    ...
    var $modal   = $('#incrementReportModal');
    var $iframe  = $('#reportIframe');
    var $loader  = $('#reportLoader');
    var $dlBtn   = $('#reportDownloadBtn');

    $('#incrementReportForm').on('submit', function(e) {
        e.preventDefault();
        var empID = $('#employeeID').val();
        var url   = '<?= $baseURL ?>api/reports/increment-pdf.php'
    ...
    // Fires when the viewer HTML has loaded (before internal PDF.js render).
