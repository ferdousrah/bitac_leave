...
$getLastDisplayOrderQ = mysqli_query($con, "SELECT * FROM sections ORDER BY display_order DESC LIMIT 0,1");
...
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        <h4 class="fw-bold mb-0"><i class="ti tabler-circle-plus me-2 text-primary"></i>নতুন শাখা যোগ করুন</h4>
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i>শাখার তথ্য প্রবেশ করান</div>
    </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="section_name" class="form-control" placeholder="শাখার নাম লিখুন" name="section_name" required>
                    </div>
                </div>
            </div>
