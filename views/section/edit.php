...
$menuslug = htmlspecialchars($_GET['menuslug'] ?? 'manage-sections');
...
// Fetch section details using prepared statement
if ($hasDeletedColumn) {
    $stmt = $con->prepare("SELECT * FROM sections WHERE id = ? AND deleted = 0");
} else {
...
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        <h4 class="fw-bold mb-0"><i class="ti tabler-edit me-2 text-primary"></i>শাখা সম্পাদনা</h4>
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i><strong class="text-dark"><?= htmlspecialchars($sectionData['section_name']) ?></strong> এর তথ্য সম্পাদনা</div>
    </div>
    ...
    <div class="card-body">
        ...
        <form class="form-login" name="form" id="form">
            ...
            <div class="form-section-header">
                <span class="section-icon-tile"><i class="ti tabler-building-community"></i></span>
                <h6 class="section-title">শাখার তথ্য</h6>
            </div>

            <div class="row mb-3">
                <label class="col-md-3 col-form-label" for="section_name">
                    শাখার নাম <span class="text-danger">*</span>
                </label>
                <div class="col-md-9">
                    <div class="input-group input-group-merge">
                        <span class="input-group-text"><i class="ti tabler-building-community"></i></span>
                        <input type="text" id="section_name" class="form-control" value="<?= htmlspecialchars($sectionData['section_name']) ?>" name="section_name" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="number" id="display_order" class="form-control" placeholder="ক্রমিক নম্বর লিখুন" name="display_order" value="<?= htmlspecialchars($sectionData['display_order']) ?>">
                    </div>
                    <small class="text-muted mt-1 d-block"><i class="ti tabler-info-circle me-1"></i>তালিকায় শাখার অবস্থান নির্ধারণ করে</small>
                </div>
            </div>
