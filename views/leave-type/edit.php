...
// Get leave type ID from query string
$dataID   = isset($_GET['dataID']) ? intval($_GET['dataID']) : 0;
$menuslug = htmlspecialchars($_GET['menuslug'] ?? 'leave-types');
...
if (!$leaveTypeData) {
    echo "<script>
        Swal.fire({
            title: 'ত্রুটি',
            text: 'ছুটির প্রকার খুঁজে পাওয়া যায়নি!',
            icon: 'error',
            confirmButtonColor: '#ff3e1d',
            customClass: { confirmButton: 'btn btn-danger' },
            buttonsStyling: false
...
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        <h4 class="fw-bold mb-0"><i class="ti tabler-edit me-2 text-primary"></i>ছুটির প্রকার সম্পাদনা</h4>
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i><strong class="text-dark"><?= htmlspecialchars($leaveTypeData['leaveTitle']) ?></strong> এর তথ্য সম্পাদনা</div>
    </div>
    ...
    <div class="card-body">
        ...
        <form class="form-login" name="form" id="form">
            ...
            <div class="form-section-header">
                <span class="section-icon-tile"><i class="ti tabler-calendar-event"></i></span>
                <h6 class="section-title">ছুটির তথ্য</h6>
            </div>

            <div class="row mb-3">
                <label class="col-md-3 col-form-label" for="leaveTitle">
                    ছুটির নাম <span class="text-danger">*</span>
                </label>
                <div class="col-md-9">
                    <div class="input-group input-group-merge">
                        <span class="input-group-text"><i class="ti tabler-calendar-event"></i></span>
                        <input type="text" id="leaveTitle" class="form-control" placeholder="ছুটির নাম লিখুন" name="leaveTitle" value="<?= htmlspecialchars($leaveTypeData['leaveTitle']) ?>" required>
                    </div>
                </div>
            </div>
