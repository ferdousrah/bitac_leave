...
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        <h4 class="fw-bold mb-0"><i class="ti tabler-circle-plus me-2 text-primary"></i>নতুন ছুটির প্রকার</h4>
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i>নতুন ছুটির প্রকারের নাম প্রবেশ করান</div>
    </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="leaveTitle" class="form-control" placeholder="ছুটির নাম লিখুন" name="leaveTitle" required>
                    </div>
                </div>
            </div>
