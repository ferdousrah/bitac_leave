...
if ($dataID === 0) {
    echo "<script>
        Swal.fire({
            ...
            window.location='manage-groups.php?menuslug={$menuslug}';
        });
    </script>";
    exit;
}
...
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        <h4 class="fw-bold mb-0"><i class="ti tabler-edit me-2 text-primary"></i>ব্যবহারকারী গ্রুপ সম্পাদনা</h4>
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i><strong class="text-dark"><?= htmlspecialchars($userGroupData['group_name']) ?></strong> এর তথ্য সম্পাদনা</div>
    </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="group_name" class="form-control" value="<?= htmlspecialchars($userGroupData['group_name']) ?>" name="group_name" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="number" id="display_order" class="form-control" placeholder="ক্রমিক নম্বর লিখুন" name="display_order" value="<?= htmlspecialchars($userGroupData['display_order']) ?>">
                    </div>
...
$(document).ready(function(){
    $('#form').on("submit", function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '../../api/users/update-group.php',
