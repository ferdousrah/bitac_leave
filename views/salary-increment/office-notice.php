...
// Get employees with approved increments for current year
$getAllEmployeeListQ = mysqli_query($con, "SELECT DISTINCT employeeID FROM yearly_salary_increment WHERE status=1 AND incrementYear='" . mysqli_real_escape_string($con, $incrementYear) . "' ORDER BY employeeID ASC");

$menuslug = htmlspecialchars($_GET['menuslug'] ?? 'salary-increment-office-notice');
?>
...
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        ...
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i>বেতন বৃদ্ধির অফিস আদেশ জেনারেট করুন</div>
    </div>
...
<!-- Office Notice Form Card -->
<div class="card simple-form-card shadow-sm border-0">
    <div class="card-body">
        <form action="office-notice-print.php" method="post" id="officeNoticeForm" onsubmit="target_popup(this)" data-turbo="false">
            <!-- Section header -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    ...
                    <small class="text-muted mt-1 d-block"><i class="ti tabler-info-circle me-1"></i>যে কর্মচারীর জন্য অফিস আদেশ জেনারেট করতে চান তাকে নির্বাচন করুন</small>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#officeNoticeForm').on('submit', function() {
