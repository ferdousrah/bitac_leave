...
$menuslug = htmlspecialchars($_GET['menuslug'] ?? 'increment-file-permission-all');
?>

<!-- Page Header -->
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-7">
        <h4 class="fw-bold mb-0"><i class="ti tabler-file-certificate me-2 text-primary"></i>ইনক্রিমেন্ট ফাইলে অনুমোদন (সকল)</h4>
        <div class="text-muted small mt-1 ms-1"><i class="ti tabler-info-circle me-1"></i>শাখা ও অর্থ বছরের ভিত্তিতে ইনক্রিমেন্ট ফাইল জেনারেট করুন</div>
    </div>
...
<div class="card simple-form-card shadow-sm border-0">
    <div class="card-body">
        <form action="file-permission-all-print.php" method="post" id="incrementForm" onsubmit="target_popup(this)" data-turbo="false">
            <!-- Section header -->
