...
$checkOfficerQ = mysqli_query($con, "SELECT employee_id, employee_name FROM employee_list WHERE organization_id = '$organization_id' AND designation = '$designationID' and employment_status=1 and pending_section_assignment=0");
