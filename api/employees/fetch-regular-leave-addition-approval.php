...
// NOTE: no Super Admin bypass here on purpose — the approve endpoint only
// accepts the assigned signatory. If the fetch bypassed and returned rows,
// Super Admin would see actionable buttons that fail with "not the signatory".
