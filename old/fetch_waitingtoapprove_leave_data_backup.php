...
if($proceed == 1){
    ...
    $nestedData['applicant_name'] = $empRow['applicant_name']."(".banglaNumber($empRow['employee_id']).")".', '.$getDesignationDetailsQRW['job_title_name'];
