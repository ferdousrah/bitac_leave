...
<div class="row mb-4">
    <div class="col-12 col-md-6">
        <h4 class="fw-bold">ব্যবহারকারী তালিকা</h4>
    </div>
    <div class="col-12 col-md-6 text-md-end">
        <a href="new_user_form.php?menuslug=<?php echo $_GET['menuslug'] ?? 'manage-user'; ?>" class="btn btn-primary" data-turbo="true">
...
function initUserListTable() {
    console.log('Initializing user list table...');
    ...
    setTimeout(function() {
        ...
        $('#userListTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "fetch_user_data.php?menuslug=" + menuslug,
                "type": "POST",
                "dataSrc": function (json) {
                    console.log('User data loaded:', json.data.length, 'rows');
                    return json.data;
                }
            },
            "columns": [
...
document.addEventListener('turbo:load', function() {
    console.log('Turbo load event - checking for user table');
    if ($('#userListTable').length) {
        console.log('User table found, initializing...');
        initUserListTable();
    }
});
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: 'post',
                url: 'delete_data.php',
                data: 'dataID=' + dataID + '&tableName=user_list',
