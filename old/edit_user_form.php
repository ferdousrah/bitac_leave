...
if ($dataID === 0) {
    echo "<script>
        Swal.fire({
            ...
            window.location='manage_user.php?menuslug=" . htmlspecialchars($_GET['menuslug'] ?? 'manage-user') . "';
        });
    </script>";
    exit;
}
...
<div class="row mb-4">
    <div class="col-12">
        <h4 class="fw-bold">ব্যবহারকারী সম্পাদনা করুন</h4>
    </div>
</div>
    ...
    <div class="card-body">
        ...
        <form class="form-login" name="form" id="form" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input type="text" id="full_name" class="form-control" placeholder="পূর্ণ নাম লিখুন" name="full_name" value="<?php echo htmlspecialchars($getUserDetailsQRW['full_name']); ?>" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <select class="js-example-basic-single" style="width: 100%;" name="employeeID" required>
                        ...
                        <option <?php if($getUserDetailsQRW['employee_id'] == $empRow['id']){ echo "selected"; } ?> value='<?php echo $empRow['id']; ?>'><?php echo Bengali_DTN($empRow['employee_id']).' - '.$empRow['employee_name']; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input type="text" id="designation" class="form-control" placeholder="পদবী লিখুন" name="designation" value="<?php echo htmlspecialchars($getUserDetailsQRW['designation']); ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input type="email" id="email" class="form-control" placeholder="ইমেইল লিখুন" name="email" value="<?php echo htmlspecialchars($getUserDetailsQRW['email']); ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input type="text" id="mobile" class="form-control" placeholder="মোবাইল নম্বর লিখুন" name="mobile" value="<?php echo htmlspecialchars($getUserDetailsQRW['mobile']); ?>">
                </div>
            </div>

            <div class="row mb-3">
                <label class="col-md-3 col-form-label">ড্যাশবোর্ড টাইপ</label>
                <div class="col-md-9">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="dashboardType" id="dashboardType1" value="1" <?php if($getUserDetailsQRW['dashboardType'] == 1){ echo "checked"; } ?>>
                        <label class="form-check-label" for="dashboardType1">
                            ইউজার ড্যাশবোর্ড
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="dashboardType" id="dashboardType2" value="2" <?php if($getUserDetailsQRW['dashboardType'] == 2){ echo "checked"; } ?>>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input type="text" id="user_id" class="form-control" placeholder="ইউজারনেম লিখুন" name="user_id" value="<?php echo htmlspecialchars($getUserDetailsQRW['user_id']); ?>" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input type="password" id="password" class="form-control" placeholder="নতুন পাসওয়ার্ড লিখুন (খালি রাখলে পূর্বের পাসওয়ার্ড বহাল থাকবে)" name="password">
                    <small class="text-muted">খালি রাখলে পূর্বের পাসওয়ার্ড বহাল থাকবে</small>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    ...
                    <div class="mt-2">
                        <label class="form-label">বর্তমান স্বাক্ষর:</label><br>
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($getUserDetailsQRW['signature']); ?>" height="40" class="border" />
                    </div>
                    <?php } ?>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <select id="user_group_id" class="form-control select2" name="user_group_id" required>
                        ...
                        <option value='<?php echo $groupRow['id']; ?>' <?php if($getUserDetailsQRW['user_group_id'] == $groupRow['id']){ echo "selected"; } ?>><?php echo htmlspecialchars($groupRow['group_name']); ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data == 0){
                    ...
                    $('.statusMsg').html('<div class="alert alert-success alert-dismissible" role="alert">ব্যবহারকারী সফলভাবে আপডেট করা হয়েছে<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
                    $('.statusMsg').show();
                    ...
                    Swal.fire({
                        ...
                        window.location.href = 'manage_user.php?menuslug=<?php echo $_GET['menuslug'] ?? 'manage-user'; ?>';
                    });
                }
                $('#form').css("opacity", "");
