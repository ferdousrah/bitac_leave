            ...
            <ul class="nav nav-tabs nav-fill" role="tablist">
                <li class="nav-item">
                    <button type="button"
                        ...
                        <span class="d-none d-sm-inline-flex align-items-center">
                            <i class="menu-icon menu-icon icon-base ti tabler-users"></i>চাকরিরত কর্মকর্তা/কর্মচারী
                        </span>
                ...
                <li class="nav-item">
                    <button type="button"
                            ...
                            aria-selected="false">
                        <span class="d-none d-sm-inline-flex align-items-center">
                            <i class="menu-icon menu-icon icon-base ti tabler-user-off"></i>অবসরপ্রাপ্ত/চাকরিরত নন
                        </span>
            ...
            <div class="tab-pane fade show active" id="active_employees" role="tabpanel">
                <div class="table-responsive">
                    <table id="activeEmployeeTable" class="table table-hover" style="width: 100%;">
                        <thead>
                            <tr>
                                <th width="120">ক্রমিক নং</th>
                                <th width="80">ফটো</th>
                                <th>নাম ও পদবি</th>
                                <th width="160">আইডি</th>
                                <th>কেন্দ্র</th>
                                <th>শাখা</th>
...
function removeData(sl, dataID) {
    console.log('removeData called with sl:', sl, 'dataID:', dataID); // Debug
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            console.log('Sending AJAX with dataID:', dataID); // Debug
            $.ajax({
                type: 'POST',
                ...
                success: function(data) {
                    if ($.trim(data) == '1') {
                        ...
                        Swal.fire({
                            title: 'ত্রুটি!',
                            text: 'ডেটা মুছে ফেলা সম্ভব হয়নি। অনুগ্রহ করে আবার চেষ্টা করুন।',
                            icon: 'error',
                            confirmButtonColor: '#696cff'
                        });
                    }
                ...
                error: function() {
                    Swal.fire({
                        title: 'ত্রুটি!',
                        text: 'সার্ভারের সাথে সংযোগ করতে ব্যর্থ হয়েছে।',
                        icon: 'error',
                        confirmButtonColor: '#696cff'
                    });
                }
