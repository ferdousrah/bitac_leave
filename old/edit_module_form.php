...
$getModuleInfoQ = mysqli_query($con, "select * from modules where dataID='$dataID'");
						...
						<input type="hidden" name="dataID" value="<?php echo $dataID; ?>" />
	                    	<div class="form-body">
			                    ...
			                    <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="projectinput1" class="form-control" name="module_name" value="<?php echo $getModuleInfoQRW['module_name']; ?>">
		                            </div>
		                        </div>
								...
								<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="icon" class="form-control"  name="icon" value="<?php echo $getModuleInfoQRW['icon']; ?>">
		                            </div>
		                        </div>
...
$(document).ready(function() {
	...
	form.on('submit', function(e) {
		...
		$.ajax({
			url: 'edit_module_data.php', // form action url
