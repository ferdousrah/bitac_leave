...
while ($empRow = mysqli_fetch_array($query)) {
    ...
    $getSignatoryDetailsQ = mysqli_query($con, "select employee_name from employee_list where designation='$empRow[designationID]' and organization_id=5 and employment_status=1");
