...
<div id="ele1" style="padding:0px; margin:0; width:100%;">
								...
								<table width="100%" align="center" border="0" style="border: 0px solid #4d4f55; border-collapse:collapse;font-size:16px;">
                                    <tbody>
										...
										<tr height="40">
											...
											<span style="margin-bottom: 5px;font-size:15px;">প্রতি : <?php echo $getEmployeeDetailsQRW['employee_name']; ?>, <?php echo $getDesignationDetailsQRW['job_title_name']; ?>, <?php echo $getSectionDetailsQRW['section_name']; ?>, <?php echo $getorgDetailsQRW['organization_name']; ?></span>
								...
								?>
								  <div class="col-sm-3" style="width: 200px;float: left;vertical-align: bottom;padding: 40px;">
									...
									<?php echo str_replace("জনাব ", "", $getEmployeeDetailsQRW['employee_name']); ?><br>
