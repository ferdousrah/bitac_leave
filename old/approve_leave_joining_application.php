	 ...
	 <?php echo $getSectionDetailsQRW['section_name']; ?>, <?php echo $getApplicgDetailsDesigQRW['organization_name']; ?>&nbsp;&nbsp;<a href="employee_leave_history?employeeID=<?php echo $getLeaveApplicationDetailsQRW['applicantID']; ?>" target="_blank"><img height="40" src="dashboard-icons/history.png" /></a>
							...
							<div class="form-group row">
		                            ...
		                            <div class="col-md-2">
		                            	...
		                            	<input type="text" class="form-control" id="spentLeaveFrom" name="spentLeaveFrom" autocomplete="off" onchange="calculateDays()" value="<?php echo convertDateTotrad($aDateFrom); ?>" <?php if($getLeaveJoiningApplocationDetailsQRW['joiningType'] == 1){ echo "readonly"; } ?> />
										
		                            </div>
									<label class="col-md-1 label-control" for="spentLeaveTo">পর্যন্ত</label>
		                            <div class="col-md-2">
										
		                            	<input type="text" class="form-control" id="spentLeaveTo" name="spentLeaveTo" autocomplete="off"  onchange="calculateDays()" value="<?php echo convertDateTotrad($requestedJoiningDate); ?>" <?php if($getLeaveJoiningApplocationDetailsQRW['joiningType'] == 1){ echo "readonly"; } ?> />
							...
							<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            		...
		                            		<select class="form-control" name="leaveTypeInTwo" required <?php if($getLeaveJoiningApplocationDetailsQRW['joiningType'] == 1){ echo "disabled"; } ?>>
												<option value=''></option>
												<option <?php if($getLeaveJoiningApplocationDetailsQRW['approvedLeaveType'] == 1){ echo "selected"; } ?> value="1">গড় বেতন </option>
												<option <?php if($getLeaveJoiningApplocationDetailsQRW['approvedLeaveType'] == 2){ echo "selected"; } ?> value="2">অর্ধ-গড় বেতন </option>
												<option <?php if($getLeaveJoiningApplocationDetailsQRW['approvedLeaveType'] == 3){ echo "selected"; } ?> value="3">নৈমিত্তিক (Casual Leave)</option>
												<option <?php if($getLeaveJoiningApplocationDetailsQRW['approvedLeaveType'] == 4){ echo "selected"; } ?> value="4">বিনা বেতনে ছুটি</option>
												<option <?php if($getLeaveJoiningApplocationDetailsQRW['approvedLeaveType'] == 5){ echo "selected"; } ?> value="5">ঐচ্ছিক ছুটি</option>
												<option <?php if($getLeaveJoiningApplocationDetailsQRW['approvedLeaveType'] == 6){ echo "selected"; } ?> value="6">কর্তনহীন ছুটি</option>
												<option <?php if($getLeaveJoiningApplocationDetailsQRW['approvedLeaveType'] == 10){ echo "selected"; } ?> value="10">অসাধারণ ছুটি</option>
											</select>
							...
							<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            		...
		                            		<textarea class="form-control" name="note" id="note">অনুমোদন করা যেতে পারে ।</textarea>
...
/*
	...
	form.on('submit', function(e) {
		...
		$.ajax({
			url: 'approve_leave_joining_application_action.php', // form action url
