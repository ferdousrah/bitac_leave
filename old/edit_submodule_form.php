...
$getModuleInfoQ = mysqli_query($con, "select * from submodules where dataID='$dataID'");
                ...
                <div id="invoice-footer">
                    <div class="row">
						...
						<input type="hidden" name="dataID" value="<?php echo $dataID; ?>" />
	                    	<div class="form-body">
	                    		<h4 class="form-section"><i class="ft-file-text"></i> Sub-Module Information</h4>
			                    <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="submodule_name">Enter Sub-Module Name: </label>
		                            <div class="col-md-9">
		                            	<input type="text" id="submodule_name" class="form-control" name="submodule_name" value="<?php echo $getModuleInfoQRW['submodule_name']; ?>">
		                            </div>
		                        </div>
								...
								<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
										...
										<?php
										  ...
										  {
										?>
											<option <?php if($getModuleInfoQRW['module_id']==$mRow['dataID']){ echo "selected='selected'";} ?> value="<?php echo $mRow['dataID']; ?>"><?php echo $mRow['module_name']; ?></option>
...
$(document).ready(function() {
	...
	form.on('submit', function(e) {
		...
		$.ajax({
			url: 'edit_submodule_data.php', // form action url
