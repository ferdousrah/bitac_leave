...
$insertApplicationQ = mysqli_query($con, "insert into `leave_joining_application`(`leaveApplicationID`, `joiningType`, `submitDate`, `requestedJoiningDate`, `applicantID`, `applicantSignature`) values('$leaveApplicationID', '1', '$submitDate', '$joiningDate', '$getLeaveApplicationDetailsQRW[applicantID]', '$signature')");
